...
install() {
  ...
  cp -ur "${SRC_DIR}/gnome-shell/gnome-shell${ELSE_DARK:-}.css"                           "${THEME_DIR}/gnome-shell/gnome-shell.css"
  ...
  cp -ur "${SRC_DIR}/gnome-shell/theme/"*.svg                                             "${THEME_DIR}/gnome-shell/assets"
